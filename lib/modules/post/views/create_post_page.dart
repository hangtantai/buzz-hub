            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  // IconButton(icon: Icon(Iconsax.task), onPressed: () {}),
                  Spacer(),
                  ElevatedButton(
                    onPressed: () async {
                      XFile? selectedMedia =
                          _mediaFiles.isNotEmpty ? _mediaFiles[0] : null;

                      final success = _mediaFiles.isNotEmpty
                          ? await _textController.createMediaPost(
                              _textController.textController.text, _mediaFiles)
                          : await _textController.createTextPost(
