        ...
        actions: [
          IconButton(
            onPressed: () {
              ...
              Obx(() => IconButton(
                icon: Icon(
                  c.isFavorited.value ? Icons.favorite : Icons.favorite_border,
        ...
        children: [
          ...
          Row(
            children: <Widget>[
              ...
              Spacer(),
              Icon(Icons.cake),
              Text('Date of Birth'), // Replace with actual date of birth
            ],
          ),
          SizedBox(height: 5),
          Row(
                        ...
                        Row(
                          children: <Widget>[
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                // write function here
                                Share.share('Check out this post', subject: 'Look what I found!');
                              },
                            ),
                          ],
                        ),
